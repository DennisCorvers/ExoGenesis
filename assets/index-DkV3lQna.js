...
const ActiveViewContext = reactExports.createContext(void 0);
const ActiveViewProvider = ({ children }) => {
  const [activeView, setActiveView] = reactExports.useState(null);
...
const _EventBus = class _EventBus {
  ...
  static get instance() {
    if (!_EventBus.m_instance) {
      _EventBus.m_instance = new _EventBus();
    }
    return _EventBus.m_instance;
  }
...
__publicField(_EventBus, "m_instance");
let EventBus = _EventBus;
const SidebarItem = (props) => {
  const { item, onClick } = props;
  const [info, setInfo] = reactExports.useState("");
  const onLevelup = reactExports.useCallback((event) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sidebar-nav-item", onClick: () => onClick(item.route), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-nav-item-content", children: [
    item.icon && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: item.icon, alt: item.text, className: "sidebar-nav-item-image" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sidebar-nav-item-text", children: item.text }),
    info !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sidebar-nav-item-info", children: info })
  ] }) });
};
const ChevronDown = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='24'%20height='24'%20viewBox='0%200%2024%2024'%20fill='none'%20stroke='currentColor'%20stroke-width='2'%20stroke-linecap='round'%20stroke-linejoin='round'%20class='lucide%20lucide-chevron-down'%3e%3cpath%20d='m6%209%206%206%206-6'/%3e%3c/svg%3e";
const ChevronRight = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='24'%20height='24'%20viewBox='0%200%2024%2024'%20fill='none'%20stroke='currentColor'%20stroke-width='2'%20stroke-linecap='round'%20stroke-linejoin='round'%20class='lucide%20lucide-chevron-right'%3e%3cpath%20d='m9%2018%206-6-6-6'/%3e%3c/svg%3e";
const Sidebar = ({ gameContext }) => {
  ...
  const renderSection = (sectionName, items2) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sidebar-nav-heading", onClick: () => toggleExpand(sectionName), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-nav-heading-content", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold mb-4", children: "Sidebar" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "sidebar-nav", children: sidebarData.filter((category) => category.entries.length > 0).map((category) => renderSection(category.name, category.entries)) })
  ] });
};
...
class ErrorBoundary extends reactExports.Component {
  ...
  render() {
    if (this.state.hasError) {
      return this.props.fallback || /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Something went wrong." });
    }
...
const GameScreen = ({ gameContext }) => {
      ...
      if (!components[sidebarEntry.route]) {
        components[sidebarEntry.route] = React.lazy(
          () => __vitePreload(() => import(
            ...
            return __vitePreload(() => import("./ErrorPage-C214zanG.js"), true ? [] : void 0, import.meta.url);
          })
        );
      }
    };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Error loading component." }), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Loading..." }), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Game Screen" }),
    ActiveViewComponent ? /* @__PURE__ */ jsxRuntimeExports.jsx(ActiveViewComponent, { gameContext }) : null
  ] }) }) });
};
const TICK_RATE = 1e3 / 60;
function Ticker({ gameContext }) {
...
class NamedObjectRegistry {
  constructor() {
    __publicField(this, "m_registry");
    this.m_registry = /* @__PURE__ */ new Map();
  }
  get objects() {
...
const _NamedObject = class _NamedObject {
  constructor(pkg, localID, name) {
    __publicField(this, "m_package");
    __publicField(this, "m_localID");
    __publicField(this, "m_name");
    __publicField(this, "m_id");
    __publicField(this, "m_uid");
    this.m_package = pkg;
    this.m_localID = localID;
    this.m_name = name;
    this.m_id = _NamedObject.formatID(this.m_package.id, this.m_localID);
    this.m_uid = _NamedObject.lastID++;
  }
  /**
  ...
  */
  ...
  static formatID(packageID, objectID) {
    return `${packageID}.${objectID}`;
  }
};
__publicField(_NamedObject, "lastID");
_NamedObject.lastID = 0;
let NamedObject = _NamedObject;
class Skill extends NamedObject {
  constructor(pkg, id, name, media) {
    super(pkg, id, name);
    //private m_unlockRequirements;
    //private m_levelRewards;
    //private pets??
    //private availablePlanets
    __publicField(this, "m_levelCap", null);
    __publicField(this, "m_media", null);
    this.m_media = media;
    this.m_levelCap = 0;
  }
  get LevelCap() {
...
class ResourceCollectionSkill extends Skill {
  constructor(pkg, id, name, media) {
    super(pkg, id, name, media);
    __publicField(this, "m_maximumConcurrentNodes");
    __publicField(this, "m_nodes");
    this.m_maximumConcurrentNodes = 0;
    this.m_nodes = /* @__PURE__ */ new Map();
  }
  get maximumConcurrentNodes() {
...
class BaseRecipe extends NamedObject {
  constructor(pkg, id, name, experienceReward, levelRequirement, actionTime) {
    super(pkg, id, name);
    __publicField(this, "m_experienceReward");
    __publicField(this, "m_levelRequirement");
    __publicField(this, "m_actionTime");
...
class MineralHarvesting extends ResourceCollectionSkill {
  ...
  registerData(dataContext) {
    ...
    skillData.recipes.forEach((recipeData) => {
...
class SkillRegistry extends NamedObjectRegistry {
  constructor() {
    super();
    __publicField(this, "m_skillTypeMap", /* @__PURE__ */ new Map());
    this.m_skillTypeMap = /* @__PURE__ */ new Map();
  }
  get mineralHarvesting() {
    return this.getSkillSafe(MineralHarvesting);
  }
  get biomassExtraction() {
    return this.getSkillSafe(BiomassExtraction);
  }
  getSkill(type) {
  ...
  getOrAddSkill(skill, dataContext) {
...
class StorageManager {
  constructor(gameContext) {
    __publicField(this, "m_items");
    __publicField(this, "m_storageSize");
    this.m_items = /* @__PURE__ */ new Map();
...
class ActionStartResult {
  constructor(canStart, reason) {
    __publicField(this, "m_canStart");
    __publicField(this, "m_reason");
...
var ActionStoppedReason = /* @__PURE__ */ ((ActionStoppedReason2) => {
  ActionStoppedReason2[ActionStoppedReason2["ManualStop"] = 0] = "ManualStop";
  ActionStoppedReason2[ActionStoppedReason2["MissingItems"] = 1] = "MissingItems";
  ActionStoppedReason2[ActionStoppedReason2["MissingPickaxe"] = 2] = "MissingPickaxe";
  return ActionStoppedReason2;
})(ActionStoppedReason || {});
class BaseEvent {
}
class GameEvent extends BaseEvent {
}
class SkillEvent extends GameEvent {
  constructor(skillState) {
    super();
    __publicField(this, "m_skillState");
...
class SkillExperienceChangedEvent extends SkillEvent {
  constructor(skill, oldExperience, newExperience) {
    super(skill);
    __publicField(this, "m_oldExperience");
    __publicField(this, "m_newExperience");
...
class ActionStoppedEvent extends SkillEvent {
  constructor(skill, action, stopReason) {
    super(skill);
    __publicField(this, "m_stopReason");
    __publicField(this, "m_action");
...
class ActionEvent extends SkillEvent {
  constructor(skill, action, isSuccessful) {
    super(skill);
    __publicField(this, "m_isSuccessful");
    __publicField(this, "m_action");
    this.m_action = action;
...
class SkillState {
  constructor(skill, playerContext) {
    __publicField(this, "m_playerContext");
    __publicField(this, "m_skill");
    __publicField(this, "m_level");
    __publicField(this, "m_experience");
    __publicField(this, "m_activeAction");
    __publicField(this, "m_progress");
  ...
  handleActionStopped(action, reason) {
...
class MineralHarvestingState extends SkillState {
  constructor(skill, playerContext) {
  ...
  onActionStopped(action, reason) {
  }
  canStartAction(action) {
    return ActionStartResult.success();
  }
}
class BiomassExtractionState extends SkillState {
  constructor(skill, playerContext) {
    super(skill, playerContext);
  }
  onActionComplete(completedAction) {
    this.player.inventory.addItem(completedAction.item, completedAction.amount);
    this.addExperience(completedAction.experienceReward);
    new ActionEvent(this, completedAction, true);
  }
  onActionStopped(stoppedAction, reason) {
    new ActionStoppedEvent(this, stoppedAction, reason);
  }
  canStartAction(action) {
    return ActionStartResult.success();
  }
...
class SkillManager {
  constructor(gameContext, playerContext) {
    // The skill the player itself can do (only 1 skill at a time).
    __publicField(this, "m_playerSelectedSkill");
    // Passive skills
    __publicField(this, "m_activeSkills");
    __publicField(this, "m_skillStates");
    this.m_playerSelectedSkill = null;
    this.m_activeSkills = /* @__PURE__ */ new Map();
    this.m_skillStates = /* @__PURE__ */ new Map();
    const skillStateMapping = /* @__PURE__ */ new Map([
  ...
  startPlayerAction(skill, action, toggle = false) {
    if (!this.isPlayerBusy) {
...
class Player {
  constructor(game) {
    __publicField(this, "m_name");
    __publicField(this, "m_inventory");
    __publicField(this, "m_skillManager");
...
class Layout {
  constructor(dataProvider) {
    __publicField(this, "sidebarLayout");
    this.sidebarLayout = dataProvider.sidebar;
  }
}
class GameContext {
  constructor(dataProvider) {
    __publicField(this, "m_player");
    __publicField(this, "m_isPaused");
    __publicField(this, "m_skillRegistry");
    __publicField(this, "m_itemRegistry");
...
class SidebarEntry {
  constructor(id, icon, route, text, module, skill) {
    __publicField(this, "m_id");
    __publicField(this, "m_icon");
    __publicField(this, "m_route");
    __publicField(this, "m_text");
    __publicField(this, "m_module");
    __publicField(this, "m_skill");
    this.m_id = id;
    this.m_icon = icon;
    this.m_route = route;
...
class SidebarLayout {
  ...
  getOrCreateCategory(categoryName) {
    let category = this.m_sidebar.find((category2) => category2.name === categoryName);
    if (!category) {
...
class DataLoader {
  constructor() {
    ...
    __publicField(this, "m_defaultPackage");
    this.packages = new PackageRegistry();
    this.skills = new SkillRegistry();
    this.items = new NamedObjectRegistry();
  ...
  registerPackage(data2) {
    ...
    let pkg = this.packages.getPackage(packageID);
    if (pkg == null) {
  ...
  registerSidebar(pkg, sidebarData) {
...
const App = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ActiveViewProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "app-container", children: gameContext ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "main-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(GameScreen, { gameContext }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Ticker, { gameContext })
    ] })
  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-message", children: "Loading Game..." }) }) });
};
...
//# sourceMappingURL=index-DkV3lQna.js.map
